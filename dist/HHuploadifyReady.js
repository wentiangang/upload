...
!function(dependencies,factory){
    ...
    function initHHuploadify(token,selector,uploader,field,title,isSingle) {
            ...
            onUploadSuccess:function(file,result){
                ...
                if(result != '') {
                    ...
                    if(result.status == 0) {
                        ...
                        $fileInstance.append('<input type="hidden" name="' + field + (!isSingle ? '[]' : '') + '" value="' + path + '">');
                    }
                }
                else {
    ...
    function resetHHuploadifyOne(selector,images,field,title) {
